  ...
  const searchResults = searchQuery.trim()
    ? celebrities.filter(
        (c) =>
          ...
          c.occupation.some((o) => o.toLowerCase().includes(searchQuery.toLowerCase())) ||
          c.films.some((f) => f.movieName.toLowerCase().includes(searchQuery.toLowerCase()))
      )
    : [];

  const industries = ['All', 'Indian Cinema', 'Indian Sports', 'Hollywood', 'Music', 'Sports', 'Global Cinema', 'European Cinema', 'K-Pop & Asian Pop', 'Latin Music'];
          ...
          <div className="relative flex-1 max-w-xl">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search celebrities, films, awards, or family..."
            ...
            {isSearchFocused && searchResults.length > 0 && (
              <div className="absolute left-0 right-0 top-full mt-2 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl overflow-hidden z-50 divide-y divide-zinc-800/50">
                <div className="p-2 text-xs font-semibold uppercase tracking-wider text-zinc-400 bg-zinc-950/50">
